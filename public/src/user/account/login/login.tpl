...
<div class="vertical-alignment-helper">
  <div class="vertical-align-center">
    ...
    <!-- outer box -->
    <div ng-controller="LoginController as login" class="gradient col-lg-8 col-md-10 col-sm-8 col-xs-12 col-lg-offset-2 col-md-offset-1  col-sm-offset-2  col-xs-offset-0">
